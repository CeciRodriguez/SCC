...
DataTable.defaults = {
    ...
    */
    "oLanguage": {
        ...
        *    } );
        */
        "sInfo": "Muestra _START_ - _END_ de _TOTAL_ resultados",
        ...
        *    } );
        */
        "sInfoEmpty": "Muetra 0 - 0 de 0 resultados",
...
$.extend(extPagination, {
    ...
    full: function (page, pages) {
        return ['Primera', 'Previa', 'Siguiente', 'Ultima'];
    },

    simple_numbers: function (page, pages) {
        return ['Previa', _numbers(page, pages), 'Siguiente'];
    },

    full_numbers: function (page, pages) {
        return ['Primera', 'Previa', _numbers(page, pages), 'Siguiente', 'Ultima'];
    },
