<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="VerSolicitud.aspx.cs" Inherits="Credito_VerSolicitud" %>
 ...
 <div>
        <asp:Panel ID="Panel1" runat="server" BackColor="#ffffff" CssClass="panel">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <asp:TextBox ID="txt_desc" runat="server" CssClass="form-control" Height="40px" MaxLength="100"
                            Width="580px" disabled="true"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <asp:TextBox ID="txt_garantias" runat="server" CssClass="form-control" Height="40px"
                            MaxLength="100" Width="580px" disabled="true"></asp:TextBox>
                ...
                <tr>
                    <td align="right">
                     <asp:Label ID="lbl_Mensaje" runat="server" CssClass="colorMje"></asp:Label>
                        <br />
                    </td>
                    <td>
                        <br />
