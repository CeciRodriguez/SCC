<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="Formatos.aspx.cs" Inherits="Credito_FormatoGarantia" %>
...
<div>
        <asp:Panel ID="Panel1" runat="server" BackColor="#ffffff" CssClass="panel">
            ...
            <div>
            <br />
            <label id="garantia" class="texto">
            El formato de garantía proporciona a la empresa la certeza de que la cantidad que  fue  entregada al cliente  será devuelta  con el interés correspondiente,
            cada cliente debe firmar como en su identificación electoral. El formato contiene las clausulas bien definidas y éstas serán  leídas  al deudor de manera
            que no haya ninguna duda, los documentos entregados a la empresa serán escritos de manera correcta. 
            </label>
            <br />
            <br />
               <asp:Button ID="btn_Agregar" runat="server" CssClass="btn btn-primary colorMje" 
                             OnClick="btn_Garantia_Click" Text="Imprimir formato de garantías" />
                <br />
                <br />
                <br />
            <label id="pagare" class="texto">
            El formato de pagaré proporciona a la empresa la certeza de que la cantidad que  fue  entregada al cliente  será devuelta  con el interés correspondiente,
            cada cliente debe firmar como en su identificación electoral. El formato contiene la fecha de inicio del crédito, la cantidad monetaria entregada en número y letra, a favor de quien va dirigido, y la fecha de expiración del crédito. 
            </label>
            <br />
            <br />
               <asp:Button ID="btn_Modificar" runat="server" CssClass="btn btn-primary colorMje"
                                OnClick="btn_Pagare_Click" Text="Imprimir pagaré" />
            </div>
        </asp:Panel>
    </div>
    <!-- ui-dialog -->
