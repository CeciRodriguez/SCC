<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="ListaClientesE.aspx.cs" Inherits="Cliente_ListaClientesE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 <div>
        <asp:Panel ID="Panel1" runat="server" BackColor="#ffffff" CssClass="panel">
            ...
            <div>
                <asp:Label ID="lblIdClienteE" runat="server" CssClass="hide"></asp:Label>
                <br />
                <br />
